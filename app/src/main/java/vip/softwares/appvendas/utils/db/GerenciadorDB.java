package vip.softwares.appvendas.utils.db;
...
public class GerenciadorDB {
	...
	/*----------------------------------------------------------------------------------------------------------------------------------------*/
	public static String PATHDB = Environment.getExternalStorageDirectory().getAbsolutePath()+"/APP_VENDAS/DB/";
	public static String NOMEDB = PATHDB+"DB_APPVENDAS.db3";
